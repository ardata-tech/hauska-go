...
func mainHauskaExample() {
	...
	factoryAddress := "0x5FbDB2315678afecb367f032d93F642f64180aa3" // Example address
	...
	balanceInGO := weiToGOHauska(balance)
...
// weiToGOHauska converts wei to GO (equivalent to ETH conversion)
func weiToGOHauska(wei *big.Int) string {
